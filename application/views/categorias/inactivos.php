        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>Categorías Inactivas</h4>
                    <p class="mb-0">Lista de Categorías Inactivas</p>
                </div>
            </div>
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?= site_url('categorias') ?>">Activas</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Inactivas</a></li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Lista de Categorías Inactivas</h4>
                    </div>
                    <div class="card-body">
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item" href="javascript:void(0);" onclick="showConfirmationMessage('<?php echo site_url('categorias/habilitar/'.$categoria['idCategoria']); ?>')">Habilitar</a>
<script type="text/javascript"> 
    ...
    function showConfirmationMessage(deleteUrl) {
        ...
        toastr.warning('¿Estás seguro de que deseas habilitar esta categoría?', 'Confirmar habilitar', {
            ...
            "onclick": function() {
                ...
                var confirmAction = confirm('¿Estás seguro de que deseas habilitar esta categoría?');
